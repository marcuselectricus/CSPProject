...
*                            V3/05-98/GHK
*                            V4/02-04/GHK
*                            V4/01-14/MA  - Interface to DE431
*
...
*----------------------------------------------------------------------
      ...
      ! Note MA 02-JAN-2014  Increase dimension of VALUES and NAMES
      !                      for consistency with DE431
      DOUBLE PRECISION TJD,POS(3),VEL(3),POSVEL(6),VALUES(1000),SSS(3),
     .     BEGJD,ENDJD,TJD1,TJD2(2),TLAST,DINT

      CHARACTER NAMES(1000)*6
...
C     --------------------------------------------------------------------------------
C     08-MAR-2025 | MA | SCR 150: Printout TJD, M and K to remove warning by GNU Fortran
      WRITE(*,FMT='(" NOVAS.AUXPOS TJD M K = ",F20.10,1X,I8,1X,I8)')
     &      TJD, M, K
C     --------------------------------------------------------------------------------
      POS(1) =  0.D0
      POS(2) =  0.D0
